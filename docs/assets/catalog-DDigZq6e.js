import"./header-BTWeqdbP.js";import"./search-DOoVJ8PC.js";const n="https://dummyjson.com/products/search?q=phone&limit=9";console.log(n);async function p(){try{const c=(await(await fetch(n)).json()).products;_(c)}catch(t){console.log(t)}}function u(t,a){return t.length>a?t.substring(0,a)+"..":t}function _(t){const a=document.getElementById("catalog-product__list");t.forEach(c=>{const e=document.createElement("li");e.classList="catalog-product__item";let i=c.title;const d=u(i,50);e.innerHTML=`<a class="product__item__content" href="/Seedra/src/pages/card/card.html">
