import"./header-BTWeqdbP.js";import"./search-DOoVJ8PC.js";const l="https://dummyjson.com/products/categories";async function p(){try{const c=await(await fetch(l)).json();d(c)}catch(a){console.error("Error fetching categories:",a)}}function d(a){const c=document.getElementById("catalog-category-list");a.forEach(s=>{const t=document.createElement("li");t.className="catalog__category-item catalog__category-btn",t.innerHTML=`
            <span class="main-product__icon"></span>   
            <p>${s.name}</p>
        `,c.appendChild(t)})}p();const o="https://dummyjson.com/products?limit=9";console.log(o);async function m(){try{const s=(await(await fetch(o)).json()).products;u(s)}catch(a){console.log(a)}}function u(a){const c=document.getElementById("main-product__list");a.forEach(s=>{const t=document.createElement("li");t.classList="main-product__item",t.innerHTML=`<a href="/Seedra/src/pages/card/card.html" class="main-product__heard-wrapper">
